(function(global, factory) {
...
})(this, function(exports, core, Subject, debounceTime, _do, common, forms) {
  "use strict";
  ...
  MinPipe.ctorParameters = function() {
    return [];
  };
  ...
  PixelConverter.ctorParameters = function() {
    return [];
  };
      ...
      if (this.dataTable.rowClick.observers.length > 0) {
        this._listeners.push(
          this.renderer.listen(this.elementRef.nativeElement, "click", function(
            ...
            return _this.dataTable.rowClicked(_this, event);
          })
        );
      }
      if (this.dataTable.rowDoubleClick.observers.length > 0) {
        this._listeners.push(
          this.renderer.listen(
            ...
            "dblclick",
            function(event) {
              return _this.dataTable.rowDoubleClicked(_this, event);
            }
          )
        );
      }
  ...
  var DataTableComponent = /** @class */ (function() {
    ...
    DataTableComponent.prototype.ngOnInit = function() {
      ...
      this.subject$ = this.subject.debounceTime(100).subscribe(function() {
    ...
    DataTableComponent.prototype.resizeColumnStart = function(
      event,
      column,
      columnElement
    ) {
    ...
    DataTableComponent.prototype._isResizeInLimit = function(
      columnElement,
      dx
    ) {
      if (
        ...
        (dx >= 0 &&
          columnElement.nextElementSibling.offsetWidth + dx <= this.resizeLimit)
      ) {
        return false;
      }
      return true;
      ...
      if (!loading) {
        ...
        if (this.columns !== undefined && this.sortBy !== undefined) {
          var col = this.columns.toArray().find(function(column) {
            return column.property === _this.sortBy;
          });
  ...
  DataTableHeaderComponent.propDecorators = {
    ...
    onKeyUpHandler: [
      { type: core.HostListener, args: ["document:keyup", ["$event"]] }
    ]
  };
  var nextId$1 = 0;
  ...
  DataTableModule.ctorParameters = function() {
    return [];
  };
